...
return function()
    ...
    hi("Conditional", colors.blue2, nil, nil)
    ...
    hi("Keyword", colors.red2, nil, "italic")
    ...
    -- Link Tree-sitter keywords directly to standard Vim syntax groups
    ...
    -- Treesitter extensions (only non-standard captures that have no native Vim counterpart)
