...
return function()
    ...
    -- Editor colors
    hi("Normal", colors.gray2, colors.background, nil)
    hi("Bold", nil, nil, "bold")
    hi("Debug", colors.blue, nil, nil)
    hi("Directory", colors.blue2, nil, nil)
    ...
    hi("CursorLineNr", colors.orange2, colors.black3, "bold")
    ...
    -- Syntax highlighting
    hi("Boolean", colors.pink, nil, "bold")
    ...
    hi("Type", colors.cyan2, nil, nil)
    hi("Typedef", colors.yellow2, nil, nil)

    -- Treesitter mappings (exact matches for modern Lua highlighting)
    hi("@keyword.return", colors.blue, nil, nil)
    hi("@keyword.function", colors.blue, nil, nil)
