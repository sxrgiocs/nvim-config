...
return function()
    ...
    -- Syntax highlighting
    hi("Boolean", colors.purple, nil, "bold")       -- true, false
    hi("Character", colors.green, nil, nil)         -- 'a'
    hi("Comment", colors.black2, nil, "italic")     -- // this
    hi("String", colors.gray, nil, nil)             -- "text"
    hi("Conditional", colors.orange, nil, "italic") -- if, else, switch
    hi("Constant", colors.cyan, nil, nil)           -- NULL, PI
    hi("Define", colors.pink, nil, nil)             -- #define
    hi("Delimiter", colors.orange, nil, nil)        -- (), {}, []
    hi("Float", colors.purple, nil, nil)            -- 3.14
    hi("Function", colors.blue, nil, nil)           -- my_function()
    hi("Identifier", colors.gray2, nil, nil)        -- variable names
    hi("Include", colors.cyan, nil, nil)            -- #include
    hi("Keyword", colors.orange, nil, "italic")     -- for, return, break
    hi("Label", colors.yellow, nil, nil)            -- case, default (JSON keys too)
    hi("Number", colors.purple, nil, nil)           -- 123
    hi("Operator", colors.orange2, nil, nil)        -- + - * /
    hi("PreProc", colors.cyan, nil, nil)            -- \documentclass
    hi("Repeat", colors.orange, nil, "italic")      -- while, for
    hi("Special", colors.pink, nil, nil)            -- escape chars, special symbols
    hi("SpecialChar", colors.orange2, nil, nil)     -- \n, \t, etc
    hi("Statement", colors.blue, nil, nil)          -- let, const, var
    hi("StorageClass", colors.cyan, nil, nil)       -- static, extern
    hi("Structure", colors.pink, nil, nil)          -- struct, class
    hi("Tag", colors.yellow, nil, nil)              -- HTML/Markdown tags
    hi("Todo", colors.yellow, nil, "bold")          -- TODO, FIXME
    hi("Type", colors.cyan, nil, nil)               -- int, float, MyClass
    hi("Typedef", colors.yellow, nil, nil)          -- typedef, using
